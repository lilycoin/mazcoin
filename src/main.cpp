...
uint256 hashGenesisBlock("0x6571ccd0746e0ee3008b20a938fe3beb136bda55381abaa3d1a586ce531aafed");
...
const string strMessageMagic = "MazCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // MazCoin: 1 days
static const int64 nTargetSpacing = 120; // MazCoin: 120 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal mazcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MazCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x06e49ae4b3a7f4586c284161ceef23a3b07ad318f0d9bdb93d266bc27eca3db8");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "North Korea says conducted successful H-bomb test";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1452102255;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086302497;

        if (fTestNet)
        {
            block.nTime    = 1452098295;
            block.nNonce   = 386926334;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf9343188010effd6dac7ffb4025cfd8d79cecf6036824a1bf533aac278c63346"));
